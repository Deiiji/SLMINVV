...
// WHAT'S NEW: 	
//	   - New Menubar and Tab navigation.
//     - New ToolTip popup for images associated with items.
//     - New SL Connection to easily get your inventory.
//     - New xml file export and import feature.
//     - Added more right-click choices
// class SalesInfo: Object class to hold all of the the pricing details for objects
// class Common: Set common strings here
// class Logs: Classes for the Log and file I/O
// class MIUtils: Misc. utility functions if needed   
// class SLMIVImage:    Object that bridges UUID, imagelog.txt, and url handling           
//LICENSE
    ...
    class SLMIVImage
    {
        ...
        public Image Get(string uuid)
        {
            ...
            if (sbImageLog.ToString().IndexOf(uuid) != -1)
            {
                ...
                {
                    string uuidbmplocal = Application.StartupPath + "\\images\\" + uuid + ".bmp";
